...
using APICryptoAzureKeyVault.Security;
...
public class TestsKeyVaultController : ControllerBase
{
    ...
    public async Task<Resultado> PostEncriptar(ParametrosOperacao dados)
    {
        ...
        var cryptoClient = new CryptographyClient(key.Value.Id,
            AzureCredentialHelper.GetClientSecretCredential(_configuration));
